...
CREATE TABLE `Categorias` (
  ...
  KEY `Categorias_CategoriaNombre` (`CategoriaNombre`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Categorias`
--
INSERT INTO `Categorias` (`CategoriaID`,`CategoriaNombre`,`Descripcion`,`Imagen`) VALUES 
 ...
 (4,'Dairy Productos','Cheeses',NULL),
...
--
-- Definition of table `ClientesDemo`
--

DROP TABLE IF EXISTS `ClientesDemo`;
CREATE TABLE `ClientesDemo` (
  `ClienteID` char(5) NOT NULL,
  `TipoClienteID` char(10) NOT NULL,
  PRIMARY KEY (`ClienteID`,`TipoClienteID`),
  KEY `FK_ClientesDemo` (`TipoClienteID`),
  KEY `FK_ClientesDemo_Clientes` (`TipoClienteID`),
  CONSTRAINT `FK_ClientesDemo` FOREIGN KEY (`TipoClienteID`) REFERENCES `ClientesDemografia` (`TipoClienteID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_ClientesDemo_Clientes` FOREIGN KEY (`ClienteID`) REFERENCES `Clientes` (`ClienteID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ClientesDemo`
--

--
-- Definition of table `ClientesDemografia`
--

DROP TABLE IF EXISTS `ClientesDemografia`;
CREATE TABLE `ClientesDemografia` (
  `TipoClienteID` char(10) NOT NULL,
  `TipoClienteDesc` longtext,
  PRIMARY KEY (`TipoClienteID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ClientesDemografia`
--
...
CREATE TABLE `Clientes` (
  ...
  KEY `Clientes_Compania` (`Compania`),
  KEY `Clientes_CodigoPostal` (`CodigoPostal`),
  KEY `Clientes_Regiones` (`Regiones`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Clientes`
--
INSERT INTO `Clientes` (`ClienteID`,`Compania`,`Contacto`,`Titulo`,`Direccion`,`Ciudad`,`Regiones`,`CodigoPostal`,`Pais`,`Telefono`,`Fax`) VALUES 
...
--
-- Definition of table `EmpleadoUbicaciones`
--

DROP TABLE IF EXISTS `EmpleadoUbicaciones`;
CREATE TABLE `EmpleadoUbicaciones` (
  `EmpleadoID` int(11) NOT NULL,
  `UbicacionID` varchar(20) NOT NULL,
  PRIMARY KEY (`EmpleadoID`,`UbicacionID`),
  KEY `FK_EmpleadoUbicaciones_Ubicaciones` (`UbicacionID`),
  CONSTRAINT `FK_EmpleadoUbicaciones_Empleados` FOREIGN KEY (`EmpleadoID`) REFERENCES `Empleados` (`EmpleadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_EmpleadoUbicaciones_Ubicaciones` FOREIGN KEY (`UbicacionID`) REFERENCES `Ubicaciones` (`UbicacionID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `EmpleadoUbicaciones`
--
INSERT INTO `EmpleadoUbicaciones` (`EmpleadoID`,`UbicacionID`) VALUES 
 (5,'10019'),
 (5,'10038'),
 (5,'11747'),
 (5,'14450'),
...
CREATE TABLE `Empleados` (
  ...
  `Titulo` varchar(30) DEFAULT NULL,
  `TituloCortesia` varchar(25) DEFAULT NULL,
  ...
  KEY `Empleados_Apellido` (`Apellido`),
  KEY `Empleados_CodigoPostal` (`CodigoPostal`),
  KEY `FK_Empleados_Empleados` (`Jefe`),
  CONSTRAINT `FK_Empleados_Empleados` FOREIGN KEY (`Jefe`) REFERENCES `Empleados` (`EmpleadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Empleados`
--
INSERT INTO `Empleados` (`EmpleadoID`,`Apellido`,`Nombre`,`Titulo`,`TituloCortesia`,`FechaNacimiento`,`FechaContratacion`,`Direccion`,`Ciudad`,`Regiones`,`CodigoPostal`,`Pais`,`Telefono`,`Extension`,`Foto`,`Notas`,`Jefe`,`RutaFoto`) VALUES 
...
CREATE TABLE `FacturaDetalle` (
  ...
  KEY `FacturaDetalle_FacturaID` (`FacturaID`),
  KEY `FacturaDetalle_FacturaDetalle` (`FacturaID`),
  KEY `FacturaDetalle_ProductoID` (`ProductoID`),
  KEY `FacturaDetalle_ProductosFacturaDetalle` (`ProductoID`),
  CONSTRAINT `FK_FacturaDetalle_Facturas` FOREIGN KEY (`FacturaID`) REFERENCES `Facturas` (`FacturaID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_FacturaDetalle_Productos` FOREIGN KEY (`ProductoID`) REFERENCES `Productos` (`ProductoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `FacturaDetalle`
--
INSERT INTO `FacturaDetalle` (`FacturaID`,`ProductoID`,`PrecioUnitario`,`Cantidad`,`Descuento`) VALUES 
 (10248,11,14,12,0),
 (10248,42,9.8,10,0),
 (10248,72,34.8,5,0),
 (10249,14,18.6,9,0),
...
CREATE TABLE `Facturas` (
  ...
  KEY `Facturas_ClienteID` (`ClienteID`),
  KEY `Facturas_ClientesFacturas` (`ClienteID`),
  KEY `Facturas_EmpleadoID` (`EmpleadoID`),
  KEY `Facturas_EmpleadosFacturas` (`EmpleadoID`),
  KEY `Facturas_FechaFactura` (`FechaFactura`),
  KEY `Facturas_FechaEnvio` (`FechaEnvio`),
  KEY `Facturas_CorreosFacturas` (`EnvioVia`),
  KEY `Facturas_CodigoPostalEnvio` (`CodigoPostalEnvio`),
  KEY `FK_Facturas_Clientes` (`ClienteID`),
  CONSTRAINT `FK_Facturas_Clientes` FOREIGN KEY (`ClienteID`) REFERENCES `Clientes` (`ClienteID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Facturas_Empleados` FOREIGN KEY (`EmpleadoID`) REFERENCES `Empleados` (`EmpleadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Facturas_Correos` FOREIGN KEY (`EnvioVia`) REFERENCES `Correos` (`CorreoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=11078 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Facturas`
--
INSERT INTO `Facturas` (`FacturaID`,`ClienteID`,`EmpleadoID`,`FechaFactura`,`FechaRegistro`,`FechaEnvio`,`EnvioVia`,`Transporte`,`NombreEnvio`,`DireccionEnvio`,`CiudadEnvio`,`RegionEnvio`,`CodigoPostalEnvio`,`PaisEnvio`) VALUES 
...
CREATE TABLE `Productos` (
  ...
  `PrecioUnitario` double DEFAULT '0',
  `UnidadesStock` smallint(6) DEFAULT '0',
  `UnidadesPedidas` smallint(6) DEFAULT '0',
  `NivelReorden` smallint(6) DEFAULT '0',
  `Discontinuado` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ProductoID`),
  KEY `Productos_CategoriasProductos` (`CategoriaID`),
  KEY `Productos_CategoriaID` (`CategoriaID`),
  KEY `Productos_ProductoNombre` (`ProductoNombre`),
  KEY `Productos_ProveedorID` (`ProveedorID`),
  KEY `Productos_ProveedoresProductos` (`ProveedorID`),
  CONSTRAINT `FK_Productos_Categorias` FOREIGN KEY (`CategoriaID`) REFERENCES `Categorias` (`CategoriaID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Productos_Proveedores` FOREIGN KEY (`ProveedorID`) REFERENCES `Proveedores` (`ProveedorID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Productos`
--
INSERT INTO `Productos` (`ProductoID`,`ProductoNombre`,`ProveedorID`,`CategoriaID`,`CantidadPorUnidad`,`PrecioUnitario`,`UnidadesStock`,`UnidadesPedidas`,`NivelReorden`,`Discontinuado`) VALUES 
...
CREATE TABLE `Regiones` (
  `RegionesID` int(11) NOT NULL,
  `RegionesDescripcion` char(50) NOT NULL,
  PRIMARY KEY (`RegionesID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Regiones`
--
INSERT INTO `Regiones` (`RegionesID`,`RegionesDescripcion`) VALUES 
 (1,'Eastern'),
 (2,'Western'),
 (3,'Northern'),
 (4,'Southern');
...
--
INSERT INTO `Correos` (`CorreoID`,`Compania`,`Telefono`) VALUES 
...
CREATE TABLE `Proveedores` (
  ...
  KEY `Proveedores_Compania` (`Compania`),
  KEY `Proveedores_PostalCode` (`CodigoPostal`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Proveedores`
--
INSERT INTO `Proveedores` (`ProveedorID`,`Compania`,`Contacto`,`Titulo`,`Direccion`,`Ciudad`,`Regiones`,`CodigoPostal`,`Pais`,`Telefono`,`Fax`,`Pagina`) VALUES 
 ...
 (16,'Bigfoot Breweries','Cheryl Saylor','Regionesal Account Rep.','3400 - 8th Avenue Suite 210','Bend','OR','97101','USA','(503) 555-9931','',''),
...
CREATE TABLE `Ubicaciones` (
  `UbicacionID` varchar(20) NOT NULL,
  `UbicacionDescripcion` char(50) NOT NULL,
  `RegionesID` int(11) NOT NULL,
  PRIMARY KEY (`UbicacionID`),
  KEY `FK_Ubicaciones_Regiones` (`RegionesID`),
  CONSTRAINT `FK_Ubicaciones_Regiones` FOREIGN KEY (`RegionesID`) REFERENCES `Regiones` (`RegionesID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Ubicaciones`
--
INSERT INTO `Ubicaciones` (`UbicacionID`,`UbicacionDescripcion`,`RegionesID`) VALUES 
 ('10019','New York',1),
 ('10038','New York',1),
 ('11747','Mellvile',1),
 ('14450','Fairport',1),
...
INSERT INTO Categorias (CategoriaID,CategoriaNombre,Descripcion,Imagen) VALUES 
 (9,'Alcoholic Beverages','Beer, wine, distilled spirits, fortified wines, cocktails',NULL),
 (10,'Animal Food','Food, pet food, snacks, training treats',NULL);

INSERT INTO Correos (CorreoID,Compania,Telefono) VALUES 
 (4,'Atlantic Transport Line','(503) 555-5555'),
 (5,'UPS','(503) 441-6789'),
 (6,'DB Schenker','unknown');
